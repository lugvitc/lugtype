...
declare module "SharedTypes2" {
  type User = {
    ...
    tags?: SharedTypes.UserTag[];
    profileDetails?: SharedTypes.UserProfileDetails;
    customThemes?: SharedTypes.CustomTheme[];
    premium?: SharedTypes.PremiumInfo;
    isPremium?: boolean;
    quoteRatings?: SharedTypes.UserQuoteRatings;
    favoriteQuotes?: Record<string, string[]>;
    lbMemory?: SharedTypes.UserLbMemory;
    allTimeLbs: SharedTypes.AllTimeLbs;
    ...
    resultFilterPresets?: SharedTypes.ResultFilters[];
    testActivity?: SharedTypes.TestActivity;
  };
}
export declare namespace SharedTypes {
...
export declare namespace SharedTypes.Config {
